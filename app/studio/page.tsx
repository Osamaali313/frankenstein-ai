...
// Coming soon agents (disabled)
const COMING_SOON_AGENTS: Agent[] = [
  {
    id: 'annabelle',
    name: 'Annabelle',
    icon: '/halloween-assets/new1-img.png',
    specialty: 'Frontend Specialist - Coming Soon',
  ...
  },
  {
    ...
    specialty: 'Backend Specialist - Coming Soon',
  ...
  },
  {
    ...
    specialty: 'Business Analyst - Coming Soon',
    description: 'The silent slasher who cuts through ambiguity to define requirements',
    expertise: ['Requirements', 'User Stories', 'Edge Cases', 'Acceptance Criteria'],
  },
  {
    id: 'pennywise',
    name: 'Pennywise',
    icon: '/halloween-assets/new5-img.png',
    specialty: 'Testing Clown - Coming Soon',
    description: 'Finds bugs where you least expect them',
    expertise: ['Testing', 'QA', 'Jest', 'Cypress', 'Debugging'],
  },
  {
    id: 'ghostface',
    name: 'Ghostface',
    icon: '/halloween-assets/new6-img.png',
    specialty: 'Security Expert - Coming Soon',
    description: 'Hunts down vulnerabilities and security flaws',
    expertise: ['Security', 'Auth', 'Encryption', 'Pentesting', 'OWASP'],
  },
  {
    id: 'valak',
    name: 'Valak',
    icon: '/halloween-assets/trick-treat1-img.png',
    specialty: 'Project Manager - Coming Soon',
  ...
  },
  {
    ...
    name: 'Pinhead',
    icon: '/halloween-assets/trick-treat2-img.png',
    specialty: 'CTO/Reviewer - Coming Soon',
