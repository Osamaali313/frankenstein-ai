...
export function GitHubButton({
  ...
  const baseClasses = cn(
    "github-btn cursor-pointer flex items-center gap-2 border-none transition-all duration-500 ease-[cubic-bezier(0.165,0.84,0.44,1)] rounded-full font-extrabold justify-center px-4 py-3 text-[0.825rem] leading-4 text-white",
    className
  )
